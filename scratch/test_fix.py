...
def clean_details_test(user_message):
    ...
    removal_patterns = [
        ...
        r"(?i)\bmobile\s+number\b", r"(?i)\bphone\s+number\b", r"(?i)\bmobile\s+no\b", r"(?i)\bmobile\b", r"(?i)\bphone\b", r"(?i)\bnumber\b",
        # THE FIX:
        r"(?i)\blocation\b", r"(?i)\baddress\b",
...
test_cases = [
    ...
    "میرا نام شاہ ہے، نمبر 12345 ہے اور لوکیشن دبئی ہے",
    "location Dubai"
]
